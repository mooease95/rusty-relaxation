...
pub fn check_precision(correct_array: Vec<Vec<i64>>, relaxed_value:f64, row: usize, column: usize, target_precision: f64) -> bool {
    let correct_value: i64 = correct_array[row][column];
